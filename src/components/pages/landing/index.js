            ...
            <section id="test">
                ...
                <div className="w3-top">
                    ...
                    <div id="navDemo" className="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
                        <a href="#about" className="w3-bar-item w3-button" onclick="toggleFunction()">
                            ABOUT
                        </a>
                        <a href="#portfolio" className="w3-bar-item w3-button" onclick="toggleFunction()">
                            PORTFOLIO
                        </a>
                        <a href="#contact" className="w3-bar-item w3-button" onclick="toggleFunction()">
                            CONTACT
                        </a>
                ...
                <div className="w3-content w3-container w3-padding-64" id="about">
                    ...
                    <p>
                        We have created a fictional "personal" website/blog, and our fictional character is a hobby photographer. Lorem ipsum dolor sit amet,
                        ...
                        id est laborum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                    ...
                    <div className="w3-row">
                        ...
                        <div className="w3-col m6 w3-hide-small w3-padding-large">
                            <p>
                                Welcome to my website. I am lorem ipsum consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                                aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                                irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat
                                non proident, sunt in culpa qui officia deserunt mollit anim id est laborum consectetur adipiscing elit, sed do eiusmod tempor
                    ...
                    <div className="w3-light-grey">
                        <div className="w3-container w3-padding-small w3-dark-grey w3-center" style={{ width: '90%' }}>
                            90%
                        </div>
                    </div>
                    <p className="w3-wide">
                    ...
                    <div className="w3-light-grey">
                        <div className="w3-container w3-padding-small w3-dark-grey w3-center" style={{ width: '85%' }}>
                            85%
                        </div>
                    </div>
                    <p className="w3-wide">
                    ...
                    <div className="w3-light-grey">
                        <div className="w3-container w3-padding-small w3-dark-grey w3-center" style={{ width: '75%' }}>
                            75%
                        </div>
                    </div>
                </div>
                ...
                <div className="w3-content w3-container w3-padding-64" id="portfolio">
                    ...
                    <p className="w3-center">
                        <em>
                            Here are some of my latest lorem work ipsum tipsum.<br></br> Click on the images to make them bigger
                        </em>
                    </p>
                    <br></br>
                    ...
                    <div className="w3-row-padding w3-center">
                        ...
                        <div className="w3-col m3">
                            <img src="../../../w3images/p2.jpg" style={maxWidth} onclick="onClick(this)" className="w3-hover-opacity" alt="Coffee beans" />
                        </div>

                        <div className="w3-col m3">
                            <img src="../../../w3images/p3.jpg" style={maxWidth} onclick="onClick(this)" className="w3-hover-opacity" alt="Bear closeup" />
                        </div>

                        <div className="w3-col m3">
                            <img src="../../../w3images/p4.jpg" style={maxWidth} onclick="onClick(this)" className="w3-hover-opacity" alt="Quiet ocean" />
                        </div>
                    </div>

                    <div className="w3-row-padding w3-center w3-section">
                        <div className="w3-col m3">
                            <img src="../../../w3images/p5.jpg" style={maxWidth} onclick="onClick(this)" className="w3-hover-opacity" alt="The mist" />
                        </div>
                        ...
                        <div className="w3-col m3">
                            <img src="../../../w3images/p7.jpg" style={maxWidth} onclick="onClick(this)" className="w3-hover-opacity" alt="Empty ghost train" />
                        </div>

                        <div className="w3-col m3">
                            <img src="../../../w3images/p8.jpg" style={maxWidth} onclick="onClick(this)" className="w3-hover-opacity" alt="Sailing" />
                        </div>
                        <button className="w3-button w3-padding-large w3-light-grey" style={marginTop64}>
                            LOAD MORE
                        </button>
                    </div>
                </div>
                ...
                <div className="w3-content w3-container w3-padding-64" id="contact">
                    ...
                    <div className="w3-row w3-padding-32 w3-section">
                        <div className="w3-col m4 w3-container">
                            <img src="./../../../w3images/map.jpg" className="w3-image w3-round" style={maxWidth} />
                        </div>
                        <div className="w3-col m8 w3-panel">
                            <div className="w3-large w3-margin-bottom">
                                <i className="fa fa-map-marker fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Chicago, US<br></br>
                                <i className="fa fa-phone fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Phone: +00 151515<br></br>
                                <i className="fa fa-envelope fa-fw w3-hover-text-black w3-xlarge w3-margin-right"></i> Email: mail@mail.com<br></br>
                            </div>
                            <p>
                                Swing by for a cup of <i className="fa fa-coffee"></i>, or leave me a note:
                            </p>
